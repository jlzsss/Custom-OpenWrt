...
svn co https://github.com/jlzsss/smartdns.git package/feeds/packages/smartdns
svn co https://github.com/jlzsss/luci-app-smartdns.git package/feeds/luci/luci-app-smartdns
